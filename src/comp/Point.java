...
/**
 * Point class to represent a generic data point in 2D space with a given ID. The objects details are immutable after instantiation as these points should not move.
 *
 */
public class Point {
	private String ID;
